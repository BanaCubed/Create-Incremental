...
>(
  ...
  describe("operations", () => {
    ...
    test("Applies correctly", () => expect(modifier.apply(10)).compare_tolerance(operation(10, 5)));
  ...
  describe("applies smallerIsBetter correctly", () => {
    describe("without smallerIsBetter false", () => {
      ...
      test("zero value", () =>
        expect(
          render(createModifier(0, { description: "test", smallerIsBetter: false }).description!),
        ).toMatchSnapshot());
      test("positive value", () =>
        expect(
          render(createModifier(5, { description: "test", smallerIsBetter: false }).description!),
        ).toMatchSnapshot());
    });
    describe("with smallerIsBetter true", () => {
      test("negative value", () =>
        expect(
          render(createModifier(-5, { description: "test", smallerIsBetter: true }).description!),
        ).toMatchSnapshot());
      test("zero value", () =>
        expect(
          render(createModifier(0, { description: "test", smallerIsBetter: true }).description!),
        ).toMatchSnapshot());
      test("positive value", () =>
        expect(
          render(createModifier(5, { description: "test", smallerIsBetter: true }).description!),
